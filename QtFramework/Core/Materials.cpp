...
{
    return (_front_ambient.a() < 1.0f && _front_diffuse.a() < 1.0f && _front_emissive.a() < 1.0f && _front_specular.a() < 1.0f &&
            _back_ambient.a() < 1.0f && _back_diffuse.a() < 1.0f && _back_emissive.a() < 1.0f && _back_specular.a() < 1.0f);
}
