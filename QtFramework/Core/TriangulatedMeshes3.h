...
namespace cagd
{
    ...
    public:
        ...
        GLvoid RenderNormals(GLdouble scale = 1.0);
        ...
        GLfloat* MapNormalBuffer(GLenum access_flag = GL_READ_ONLY) const;  // homework ._.
        GLfloat* MapTextureBuffer(GLenum access_flag = GL_READ_ONLY) const; // homework ._.

        // unmapping vertex buffer objects
        GLvoid UnmapVertexBuffer() const;
        GLvoid UnmapNormalBuffer() const;   // homework ._.
        GLvoid UnmapTextureBuffer() const;  // homework ._.

        // get properties of geometry
        size_t VertexCount() const; // homework ._.
        size_t FaceCount() const;   // homework ._.
